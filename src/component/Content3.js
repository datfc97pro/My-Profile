  ...
  render() {
    return (
      <section
        ...
        className="section section-project container-fluid"
        id="projects"
      >
          ...
          <div className="row">
            <div className="col-md-3 mb-5">
              <div className="card" style={{ width: "100%" }}>
                <a
                  href="https://vuejs-share.herokuapp.com/"
            ...
            <div className="col-md-3 mb-5">
              <div className="card" style={{ width: "100%" }}>
                <a
                  href="https://bwd-react.herokuapp.com/"
                  style={{ background: "#282c34" }}
                  target="_b_blank"
                >
                  <img
            ...
            <div className="col-md-3 mb-5">
              <div className="card" style={{ width: "100%" }}>
                <a
                  href="https://bwd-angular.herokuapp.com/"
                  style={{ background: "#282c34" }}
                  target="_b_blank"
                >
                  <img
            ...
            <div className="col-md-3 mb-5">
              <div className="card" style={{ width: "100%" }}>
                <a
                  href="https://react-ngodat97.herokuapp.com/"
                  style={{ background: "#282c34" }}
                  target="_b_blank"
                >
                  <img
